export declare type InfiniteTmxModel = TmxModel<InfiniteTmxLayer>;
export declare type FiniteTmxModel = TmxModel<FiniteTmxLayer>;
...
export declare function isInfiniteLayer(layer: TmxLayer): layer is InfiniteTmxLayer;
export declare function isFiniteLayer(layer: TmxLayer): layer is FiniteTmxLayer;
